export const Button = ({
  ...
  const base = 'inline-flex items-center justify-center px-4 py-2 rounded-2xl font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-60'
  const variants = {
